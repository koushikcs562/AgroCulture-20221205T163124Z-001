							...
							<div class="col-sm-2">
								<div class="select-wrapper" style="width: auto" >
									<select name="type" id="type" required style="background-color:white;color: black;">
										...
										<option value="fruit" style="color: black;">Tractors</option>
										<option value="vegetable" style="color: black;">Cutting machine</option>
										<option value="grain" style="color: black;">Rice Transplanting Machine</option>
									</select>
							  	</div>
							</div>
							<div class="col-sm-2">
